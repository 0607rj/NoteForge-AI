    ...
    <div className='min-h-screen overflow-hidden bg-white text-black px-8'>
        ...
        >
            <h1 className='text-5xl lg:text-6xl font-extrabold leading-tight
              ...
              bg-clip-text text-transparent'>
                Create exam notes, project notes, charts, graphs and
            download clean PDFs — instantly using AI, completely free.
              </p>
              <p className='mt-4 text-sm text-gray-500'>Free unlimited access • No payment required • Instant results</p>

        </motion.div>

        {/* RIGHT CONTENT */}
        <div className='grid grid-cols-1 sm:grid-cols-2 gap-8'>
            <Feature icon="�" title="Completely Free" des="Unlimited note generation with no payment required."/>
